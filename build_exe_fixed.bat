...
if exist "dist\SmartCombinedDetection.exe" (
    ...
    echo  📁 Models: dist\models\*.blob
    echo.
    echo  🎯 To test: cd dist ^&^& SmartCombinedDetection.exe
    echo.
    echo  📦 To distribute: Copy entire 'dist' folder
    echo     (includes EXE + models folder)
    echo.
    echo ═══════════════════════════════════════════════════════════
) else (
    echo ❌ EXE not found!
